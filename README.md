...
4. The agent checks whether the sources are actually sufficient — if not, it runs a targeted follow-up search.
5. Source content is summarized.
6. Google Gemini analyzes the retrieved information.
7. The findings are synthesized into a structured, citation-grounded report.
